...
function insertarCarrito(cafe){
    ...
    row.innerHTML = `
        ...
        <td>${cafe.precio}</td>
        <td>
            <a href="#" class="borrar-cafe" data-id="${cafe.id}"></a>
        </td>
    `;
...
function eliminarCafe(e){
    ...
    if(e.target.classList.contains('borrar-cafe')){
        ...
        cafe = e.target.paarentElement.parentElement;
...
function leerLocalStorage(){
    ...
    cafesLS.forEach(function(cafe){
        ...
        row.innerHTML = `
            ...
            <td>${cafe.precio}</td>
            <td>
                <a href="#" class="borrar-cafe" date-id="${cafe.id}">X</a>
            </td>
        `;
        listaCafes.appendChild(row);
    });
...
function eliminarCafesLocalStorange(cafe){
    let cafesLS;
